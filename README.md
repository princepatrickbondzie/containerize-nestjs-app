...
A local development setup for [Nest.js](https://nestjs.com/) with [PostgreSQL](https://www.postgresql.org/) and [pgAdmin4](https://www.pgadmin.org/) using [Docker Compose](https://docs.docker.com/compose/).
...
```bash
git clone git@github.com:princepatrickbondzie/containerize-nestjs-app.git
```

5. Install npm packages - _for IDE type checking_.

```bash
cd containerize-nestjs-app
...
7. Access the app at http://localhost:6100.
